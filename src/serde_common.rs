...
pub enum SError {
    ...
    /// Indicates that a field given in a list of fields was not found in the map or struct.
    /// Note that this may not be returned if none of the fields were found.
