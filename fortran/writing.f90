...
write(*, '(a7,e12.4,a1)') '    0 |',0.0,'|'
write(*, '(a7,1pe12.4,a1)') ' 1p 0 |',0.0,'|'
write(*, '(a7,2pe12.4,a1)') ' 2p 0 |',0.0,'|'
write(*, '(a7,-1pe12.4,a1)') '-1p 0 |',0.0,'|'
write(*, '(a7,-2pe12.4,a1)') '-2p 0 |',0.0,'|'
write(*, '(a7,e12.4,a1)') '    1 |',1.0,'|'
write(*, '(a7,1pe12.4,a1)') ' 1p 1 |',1.0,'|'
write(*, '(a7,2pe12.4,a1)') ' 2p 1 |',1.0,'|'
write(*, '(a7,-1pe12.4,a1)') '-1p 1 |',1.0,'|'
write(*, '(a7,-2pe12.4,a1)') '-2p 1 |',1.0,'|'
write(*, '(a8,e12.4,a1)') '    -1 |',-1.0,'|'
write(*, '(a8,1pe12.4,a1)') ' 1p -1 |',-1.0,'|'
write(*, '(a8,2pe12.4,a1)') ' 2p -1 |',-1.0,'|'
write(*, '(a8,-1pe12.4,a1)') '-1p -1 |',-1.0,'|'
write(*, '(a8,-2pe12.4,a1)') '-2p -1 |',-1.0,'|'
...
write(*, '(a1)') ' '
write(*, '(a7,d12.4,a1)') '    0 |',0.0,'|'
write(*, '(a7,1pd12.4,a1)') ' 1p 0 |',0.0,'|'
write(*, '(a7,2pd12.4,a1)') ' 2p 0 |',0.0,'|'
write(*, '(a7,-1pd12.4,a1)') '-1p 0 |',0.0,'|'
write(*, '(a7,-2pd12.4,a1)') '-2p 0 |',0.0,'|'
write(*, '(a7,e12.4,a1)') '    1 |',1.0,'|'
write(*, '(a7,1pd12.4,a1)') ' 1p 1 |',1.0,'|'
write(*, '(a7,2pd12.4,a1)') ' 2p 1 |',1.0,'|'
write(*, '(a7,-1pd12.4,a1)') '-1p 1 |',1.0,'|'
write(*, '(a7,-2pd12.4,a1)') '-2p 1 |',1.0,'|'
write(*, '(a8,d12.4,a1)') '    -1 |',-1.0,'|'
write(*, '(a8,1pd12.4,a1)') ' 1p -1 |',-1.0,'|'
write(*, '(a8,2pd12.4,a1)') ' 2p -1 |',-1.0,'|'
write(*, '(a8,-1pd12.4,a1)') '-1p -1 |',-1.0,'|'
write(*, '(a8,-2pd12.4,a1)') '-2p -1 |',-1.0,'|'
